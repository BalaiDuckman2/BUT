/**
 * \brief programme de pure de cramptage
 * \author lui
 * \version 1.0
 * \date aujourd'hui
 * 
...
#define TMAX 20	/** \def   Taille Maximum d'une chaine quand on veut*/
				// ordonner ses caract�res

typedef struct Elem {		// structure d'un �l�ment de la
    char lettre;			// liste chain�e. Compos�e d'un
    struct Elem * svt;	// caract�re et d'un pointeur sur 
}element;				// le caract�res suivant
