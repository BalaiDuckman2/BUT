 ...
 * \details affiche les coordonnées d'un point graçe a la structure Point2D qui est pris en paramêtre
 ...
 * \details Calcule la distance entre deux points mis en paramètre en fesant une 
 ...
 * \details Calcule l'aire d'un rectangle mis en paramètre en calculant 
 ...
 * \details -initialise deux point(pointA, PointB) de type Point2D
...
*/
int main() {
    Point2D pointA = {1.0, 2.0}; /**Coordonné x et y d'un point A*/
    Point2D pointB = {4.0, 6.0}; /**Coordonné x et y d'un point B*/
    Rectangle monRectangle = {{2.0, 3.0}, {6.0, 5.0}};/**Création d'un réctangle*/
    float distance; /**Stocke le résultat de la distance entre deux points*/
    float aireRectangle; /**Stocke le résultat de l'aire du rectangle*/
